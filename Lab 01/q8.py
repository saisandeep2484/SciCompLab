...
def iterativeMethod(x_init):
    ...
    while 1:
        n+=1
        num1 = f(x_cur)*f(x_cur)
        denom1 = f(x_cur) - f(x_cur-f(x_cur))
        x_next = x_cur - num1/denom1
    ...
    print("The ratio converges to 2 after several iterations, and hence order of convergence = 2.")
